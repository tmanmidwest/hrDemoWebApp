#!/bin/bash
# =============================================================================
# teardown.sh — hrDemoWebApp Complete AWS Resource Cleanup
# =============================================================================
# Usage:  ./teardown.sh
# Reads resource IDs from .hr-demo-state (created by deploy.sh)
# =============================================================================
...
echo ""
echo -e "${BOLD}${RED}═══════════════════════════════════════════════════${NC}"
echo -e "${BOLD}${RED}  hrDemoWebApp — Complete Teardown${NC}"
echo -e "${BOLD}${RED}═══════════════════════════════════════════════════${NC}"
echo ""
