#!/bin/bash
# =============================================================================
# manage.sh — hrDemoWebApp Day-to-Day Management
# =============================================================================
# Usage:
...
case "$CMD" in
  ...
  status)
    echo ""
    echo -e "${BOLD}  hrDemoWebApp — Status${NC}"
    echo -e "  ─────────────────────────────────────────"
  ...
  stop)
    echo ""
    log "Stopping hrDemoWebApp (setting desired count to 0)..."
  ...
  help|*)
    echo ""
    echo -e "${BOLD}  hrDemoWebApp — Management Commands${NC}"
    echo ""
