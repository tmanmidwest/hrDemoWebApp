#!/bin/bash
# =============================================================================
# setup.sh — Pre-deployment prerequisite checker for hrDemoWebApp
# =============================================================================
...
echo ""
echo -e "${BOLD}${BLUE}  hrDemoWebApp — Setup Checker${NC}"
...
if curl -sf "https://github.com/tmanmidwest/hrDemoWebApp" >/dev/null 2>&1; then
  pass "GitHub repo is reachable (https://github.com/tmanmidwest/hrDemoWebApp)"
else
